	...
	if ($message !== '' && $chattouser !== '') {
		...
		if($result){
			...
			if(move_uploaded_file($message2, $target_file)){
				$query = "INSERT INTO `messagechat`(`sender`, `receiver`, `category`, `audio`, `date`) VALUES ('$_COOKIE[userId]','$chattouser','$chatuserlist[category]','$message','$dt')";
